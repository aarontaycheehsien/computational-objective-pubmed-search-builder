#!/usr/bin/env python3
"""Small PubMed E-utilities helper for the computational-objective-pubmed skill."""
...
DEFAULT_EMAIL = ""
DEFAULT_TOOL = "computational-objective-pubmed-check"
...
def write_xlsx(path: Path, sheets: list[tuple[str, list[list[object]]]]) -> None:
    ...
    with zipfile.ZipFile(path, "w", compression=zipfile.ZIP_DEFLATED) as archive:
        ...
        archive.writestr(
            ...
            "<dc:creator>computational-objective-pubmed</dc:creator>"
        ...
        archive.writestr(
            ...
            "<Application>computational-objective-pubmed</Application></Properties>",
        )
...
def build_audit_scaffold(
    *,
    ...
    if slug:
        audit["title"] = f"Computational objective PubMed search audit: {slug}"
        audit["topic"] = slug
